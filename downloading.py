...
class DownloadManager:
    ...
    def _get_file_size(self):
        ...
        # 尝试 HEAD 请求
        try:
            head_response = requests.head(self.url, allow_redirects=True, headers=config.headers, impersonate="chrome")
        ...
        try:
            ...
            response = requests.get(self.url, stream=True, headers=headers, impersonate="chrome")
    ...
    def _download_part(self, start_byte, end_byte, part_num, progress_callback=None):
        ...
        try:
            response = requests.get(self.url, stream=True, headers=headers_copy, impersonate="chrome")
